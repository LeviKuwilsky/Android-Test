...
lifecycle = "2.10.0"
room = "2.8.4"
retrofit = "2.11.0"          # ggf. neueste prüfen
okhttp = "4.12.0"            # ggf. neueste prüfen
...
# Lifecycle / ViewModel / Compose-Flow
...
plugins {
    ...
    alias(libs.plugins.kotlin.serialization) // für kotlinx.serialization
}
